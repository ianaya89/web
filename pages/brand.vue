<template>
  <div class="brand-page overflow-hidden">
    <!-- Hero Section -->
    <div class="min-h-screen w-full flex relative">
      <div class="w-full h-screen flex absolute top-0">
        <transition name="clip-path-slide-up" :appear="true">
          <div class="w-full h-full hero-bg-brand-img-01 bg-cover bg-right bg-no-repeat" />
        </transition>
      </div>
      <!-- <animated-image :src="require('../assets/images/landing.jpg')" alt="Landing image" class="h-auto xl:h-full max-w-none xl:w-full" /> -->
      <div class="w-4 sm:w-16 xl:w-1/5 pl-4 xl:pl-10 z-10">
      ...
      <div class="xl:w-3/5 flex z-10">
        <div class="border-l border-light-line sm:pt-24 text-white flex flex-wrap items-center">
          <div class="pt-16">
            ...
            <transition name="fade-up-delayed" :appear="true">
              <animated-button :title="$t('landing.brand.title_signup')" :show-arrow="true" @clicked="redirectToBrandSignup" />
            </transition>
          </div>
        </div>
      </div>
    ...
    <!-- Map Section  -->
    <div class="w-full flex bg-white mt-16 lg:mt-56 xl:mt-0">
      ...
      <div class="w-full xl:w-4/5 xl:pt-32">
        <appear-transition :percentage-offset="0.1" class="w-full block flex flex-wrap-reverse sm:flex-wrap h-full relative">
          <highlighted-world-map
            ...
            @country-clicked="redirectToBrandSignup"
          />
            ...
            <appear-transition>
              <div class="how-to-section sm:mt-48 xl:mt-32">
                <h3 class="uppercase text-h4 border-b-8 border-grey-l3 pb-1 inline">
                  {{ $t('landing.brand.how_it_works.sign_up.title') }}
                </h3>
                <p class="how-to-text">
                  {{ $t('landing.brand.how_it_works.sign_up.body') }}
                </p>
              </div>
            </appear-transition>
            <appear-transition>
              <div class="how-to-section">
                <h3 class="uppercase text-h4 border-b-8 border-grey-l3 pb-1 inline">
                  {{ $t('landing.brand.how_it_works.search.title') }}
                </h3>
                <p class="how-to-text">
                  {{ $t('landing.brand.how_it_works.search.body') }}
                </p>
              </div>
            </appear-transition>
            <appear-transition>
              <div class="how-to-section">
                <h3 class="uppercase text-h4 border-b-8 border-grey-l3 pb-1 inline">
                  {{ $t('landing.brand.how_it_works.communication.title') }}
                </h3>
                <p class="how-to-text">
                  {{ $t('landing.brand.how_it_works.communication.body') }}
                </p>
              </div>
            </appear-transition>
            <appear-transition>
              <div class="how-to-section">
                <h3 class="uppercase text-h4 border-b-8 border-grey-l3 pb-1 inline">
                  {{ $t('landing.brand.how_it_works.deals.title') }}
                </h3>
                <p class="how-to-text">
                  {{ $t('landing.brand.how_it_works.deals.body') }}
                </p>
              </div>
            </appear-transition>
            <div class="px-8 sm:px-0">
              <app-button :title="$t('general.get_started')" :btn-class="'primary-lg'" :show-arrow="true" class="w-full sm:w-auto" @clicked="redirectToBrandSignup" />
            </div>
            <iframe
              title="SPONSOR.ONLINE video"
              class="w-full mt-16 mb-24 lg:mb-48 h-64 xl:h-128"
              src="https://www.youtube.com/embed/GXxaYWnZdyk?controls=0&rel=0"
              frameborder="0"
      ...
      <div class="w-full xl:w-4/5 feature-section lg:border-l border-grey-l3">
        ...
        <animated-features
          :items="
            [
              {
                name: $t('landing.brand.under_hood.search'),
                image: require('../assets/images/landing/marketplace.jpg')
              },
              {
                name: $t('landing.brand.under_hood.comparison'),
                image: require('../assets/images/landing/compare.jpg')
              },
              {
                name: $t('landing.brand.under_hood.deal_proposal'),
                image: require('../assets/images/landing/deal-proposal.jpg')
              }
            ]"
          :force-animate="true"
          :title="$t('landing.team.under_hood.title')"
          :body="$t('landing.brand.under_hood.body')"
        />
      </div>
    </div>
    ...
    <div class="w-full flex flex-wrap">
      <div class="w-full xl:w-2/5 lg:border-r border-grey-l3 flex pt-24 sm:pt-40 xl:pt-48">
        <div class="w-full xl:w-auto xl:max-w-xxs xl:mx-auto px-8 xl:px-0">
          ...
          <app-button class="mt-10 w-full xl:w-auto hidden" :title="$t('landing.brand.title_signup')" :btn-class="'primary-lg'" @clicked="redirectToBrandSignup" />
    ...
    <!--              <p class="text-grey-l1 text-h7">-->
    <!--                {{ $t('landing.team.advisors.body') }}-->
    <!--              </p>-->
    <!--            </div>-->
    <!--            <app-button :title="$t('general.find_out_more')" :btn-class="'primary-lg'" class="mt-12" @clicked="redirectToBrandSignup" />-->
    <!--          </div>-->
    <!--        </appear-transition>-->
    <!--      </div>-->
      ...
      <appear-transition :percentage-offset="0.5">
        <div class="w-full relative pt-24 xl:pt-32 pb-32 xl:pb-32">
          <div class="max-w-md -mt-2 px-8 pt-4">
            <h2 class="uppercase text-h2 sm:text-h1 font-medium leading-none">
          ...
          <div class="px-8 xl:px-0 ">
            <app-button :title="$t('general.lets_get_started')" :btn-class="'primary-lg'" :show-arrow="true" class="w-full sm:w-auto" @clicked="redirectToBrandSignup" />
          </div>
        </div>
      </appear-transition>
    </div>
...
.hero-bg-brand-img-01 {
  background-image: url('../assets/images/brand-page.jpg');
}
</style>
