...
export default {
  ...
  apollo: {
    teamWithPlayersSocialAccounts: {
      ...
      update(data) {
        data.teamWithPlayersSocialAccounts.map(item => {
        ...
        return data.teamWithPlayersSocialAccounts
      },
      result() {
  ...
  computed: {
    ...
    socialMedia() {
      return this.teamWithPlayersSocialAccounts.filter(media => {
    ...
    socialMediaTypeSelectorItems() {
      return orderBy(
        [
          { text: 'All', value: 'all' },
          ...uniqBy(
            this.teamWithPlayersSocialAccounts
