<template>
  <section class="team__profile__fans">
    ...
    <appear-transition :percentage-offset="0.6">
      <league-media-sources-overview v-if="accessMedia" :unit-id="unitId" />
    </appear-transition>
...
import LeagueMediaSourcesOverview from '@/components/widgets/profile-fans/LeagueMediaSourcesOverview'
