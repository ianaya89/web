<template>
  <section class="team__profile w-full">
    <league-profile-header :unit-id="this.$route.params.id" :season="activeSeason.name" />
...
export default {
  ...
  computed: {
    ...
    accessFansAndReach() {
      return this.checkPermission('access-league-fans-reach')
    },

    accessPlayers() {
      return this.checkPermission('access-league-players')
    },

    accessLeague() {
      return this.checkPermission('access-league-league')
    },
